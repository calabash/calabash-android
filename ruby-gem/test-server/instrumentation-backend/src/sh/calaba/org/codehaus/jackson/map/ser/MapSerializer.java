...
/**
 * @deprecated Since 1.9 use {@link sh.calaba.org.codehaus.jackson.map.ser.std.MapSerializer}
 */
@Deprecated
@JacksonStdImpl
public class MapSerializer
    extends sh.calaba.org.codehaus.jackson.map.ser.std.MapSerializer
{
