 ...
 * and  {@link sh.calaba.org.codehaus.jackson.map.ObjectMapper} (or objects
 * it delegates to) providing matching filters by id.
 * Filters to use are of type
 * {@link sh.calaba.org.codehaus.jackson.map.ser.BeanPropertyFilter} and
 * are registered through {@link sh.calaba.org.codehaus.jackson.map.ObjectMapper}
 * 
 * @since 1.7
 */
