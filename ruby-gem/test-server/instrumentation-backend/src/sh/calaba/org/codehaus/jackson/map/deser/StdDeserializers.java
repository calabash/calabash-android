...
import sh.calaba.org.codehaus.jackson.map.deser.std.AtomicBooleanDeserializer;
import sh.calaba.org.codehaus.jackson.map.deser.std.CalendarDeserializer;
import sh.calaba.org.codehaus.jackson.map.deser.std.ClassDeserializer;
import sh.calaba.org.codehaus.jackson.map.deser.std.DateDeserializer;
import sh.calaba.org.codehaus.jackson.map.deser.std.FromStringDeserializer;
import sh.calaba.org.codehaus.jackson.map.deser.std.JavaTypeDeserializer;
import sh.calaba.org.codehaus.jackson.map.deser.std.StdDeserializer;
import sh.calaba.org.codehaus.jackson.map.deser.std.StringDeserializer;
import sh.calaba.org.codehaus.jackson.map.deser.std.TimestampDeserializer;
import sh.calaba.org.codehaus.jackson.map.deser.std.TokenBufferDeserializer;
import sh.calaba.org.codehaus.jackson.map.deser.std.UntypedObjectDeserializer;
