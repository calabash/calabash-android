...
import sh.calaba.org.codehaus.jackson.map.ser.std.NonTypedScalarSerializerBase;
import sh.calaba.org.codehaus.jackson.map.ser.std.ScalarSerializerBase;
...
public class StdSerializers
{
    ...
    /**
     * @deprecated Since 1.9, use {@link sh.calaba.org.codehaus.jackson.map.ser.std.StringSerializer} instead
     */
    @Deprecated
    @JacksonStdImpl
    ...
    /**
     * @deprecated Since 1.9, use {@link sh.calaba.org.codehaus.jackson.map.ser.std.DateSerializer} instead
     */
    @JacksonStdImpl
    @Deprecated
    public final static class CalendarSerializer
        extends sh.calaba.org.codehaus.jackson.map.ser.std.CalendarSerializer { }
    ...
    public final static class UtilDateSerializer
        extends sh.calaba.org.codehaus.jackson.map.ser.std.DateSerializer {
    ...
    public final static class SerializableSerializer
        extends sh.calaba.org.codehaus.jackson.map.ser.std.SerializableSerializer { }
    ...
    public final static class SerializableWithTypeSerializer
        extends sh.calaba.org.codehaus.jackson.map.ser.std.SerializableWithTypeSerializer {
    }
}
