...
public class OptionalHandlerFactory
{
    ...
    private final static String SERIALIZERS_FOR_JODA_DATETIME = "sh.calaba.org.codehaus.jackson.map.ext.JodaSerializers";
    private final static String SERIALIZERS_FOR_JAVAX_XML = "sh.calaba.org.codehaus.jackson.map.ext.CoreXMLSerializers";
    private final static String DESERIALIZERS_FOR_JODA_DATETIME = "sh.calaba.org.codehaus.jackson.map.ext.JodaDeserializers";
    private final static String DESERIALIZERS_FOR_JAVAX_XML = "sh.calaba.org.codehaus.jackson.map.ext.CoreXMLDeserializers";
    ...
    private final static String SERIALIZER_FOR_DOM_NODE = "sh.calaba.org.codehaus.jackson.map.ext.DOMSerializer";
    private final static String DESERIALIZER_FOR_DOM_DOCUMENT = "sh.calaba.org.codehaus.jackson.map.ext.DOMDeserializer$DocumentDeserializer";
    private final static String DESERIALIZER_FOR_DOM_NODE = "sh.calaba.org.codehaus.jackson.map.ext.DOMDeserializer$NodeDeserializer";
