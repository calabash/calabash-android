...
public class MapViewUtils {
	 ...
	 */
	public MapViewUtils(final Instrumentation inst,
	 ...
	 * @param lon
	 */
	public void panTo(final double lat, final double lon) {
		MapView mapView = getMapView();
	 ...
	 */
	public String getMarkerItem(final String title) {
		ArrayList<String> markers = new ArrayList<String>();
	 ...
	 */
	public boolean tapMarkerItem(final String title, final long timeout) {
	...
	/**
	 * @param step
	 *          - number of pixels to step when searching for an empty piece of screen
	 * @return true if it was possible to tap on the screen without tapping on a marker
	 */
	@SuppressWarnings("rawtypes")
	public boolean tapAwayFromMarkerItems(final int step) {
		MapView mapView = getMapView();
	 ...
	 */
	private String toString(final OverlayItem item, final boolean isLastFocused) {
	...
	private void appendTransparency(final StringBuilder str, final OverlayItem item) {
	...
	private void appendTransparency(final StringBuilder str,
