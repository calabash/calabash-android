...
import sh.calaba.org.codehaus.jackson.map.ser.impl.PropertySerializerMap;
 ...
 * 
 * @since 1.9 (moved from 'sh.calaba.org.codehaus.jackson.map.ser.impl.ObjectArraySerializer')
 */
@JacksonStdImpl
